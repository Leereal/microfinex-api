 ...
 */
export async function seedPermissions(req: Request, res: Response): Promise<void> {
  try {
 ...
 */
export async function getPermissionsByModule(req: Request, res: Response): Promise<void> {
  try {
 ...
 */
export async function assignPermissionsToRole(req: Request, res: Response): Promise<void> {
  try {
    const roleId = req.params.roleId!;
 ...
 */
export async function assignRoleToUser(req: Request, res: Response): Promise<void> {
  try {
 ...
 */
export async function removeRoleFromUser(req: Request, res: Response): Promise<void> {
  try {
    const userId = req.params.userId!;
    const roleId = req.params.roleId!;
 ...
 */
export async function setUserDirectPermission(req: Request, res: Response): Promise<void> {
  try {
    const userId = req.params.userId!;
 ...
 */
export async function removeUserDirectPermission(req: Request, res: Response): Promise<void> {
  try {
    const userId = req.params.userId!;
 ...
 */
export async function getUserEffectivePermissions(req: Request, res: Response): Promise<void> {
  try {
    const userId = req.params.userId!;
 ...
 */
export async function seedDefaultRoles(req: Request, res: Response): Promise<void> {
  try {
    const organizationId = req.params.organizationId!;
